...
DESCRIPTION
***********
This file is based on ..._160419_001 but excludes regions containing districts 
from East Germany from the sample.

These are the regions 8, 9, 13, 93, 94 and 109 onwards.
*******************************************************************************/
...
drop if inlist(lmr_id, 8, 9, 13, 93, 94) 

drop if inrange(lmr_id, 109, 141)	//	excludes regions containing East German districts
...
foreach word of local words {
	...
	excel append dec(5) ///
	ctitle("ln_unemp_rate`word'", "OLS", "robust", "No East") ///
	...
	outreg2 using ${anal}/Analysis_Demo_`filedate'_`filenum'.xls, ///
	excel append dec(5) ///
	ctitle("ln_unemp_rate`word'", "2SLS", "robust", "No East") ///
	sortvar(ln_pop_share_20_24 ln_pop_share_18_24 ln_pop_share_15_24)
	...
	outreg2 using ${anal}/Analysis_Demo_`filedate'_`filenum'.xls, ///
	excel append dec(5) ///
	ctitle("ln_emp_rate`word'", "OLS", "robust", "No East") ///
	sortvar(ln_pop_share_20_24 ln_pop_share_18_24 ln_pop_share_15_24)
	...
	outreg2 using ${anal}/Analysis_Demo_`filedate'_`filenum'.xls, ///
	excel append dec(5) ///
	ctitle("ln_emp_rate`word'", "2SLS", "robust", "No East") ///
	sortvar(ln_pop_share_20_24 ln_pop_share_18_24 ln_pop_share_15_24)
