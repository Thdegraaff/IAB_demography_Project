...
on age-specific employment rates.
...
gen emp_share_25_29 = emp_25_29/(pop_20_24 + pop_25_29 + pop_30_34 + ///
pop_35_39 + pop_40_44 + pop_45_49 + pop_50_54 + pop_55_59 + pop_60_64)

gen emp_share_20_29 = (emp_20_24 + emp_25_29)/(pop_20_24 + pop_25_29 + ///
pop_30_34 + pop_35_39 + pop_40_44 + pop_45_49 + pop_50_54 + pop_55_59 + ///
pop_60_64)

label variable emp_share_25_29 "Ratio of employed aged 25-29 to population 20-64"

label variable emp_share_20_29 "Ratio of employed aged 20-29 to population 20-64"
...
foreach var of varlist emp_share_25_29 emp_share_20_29 {
...
foreach word of local words {
	...
	regress ln_emp_share`word' ln_pop_share`word' i.year i.lmr_id, ///
	vce(robust)
		
	outreg2 using ${anal}/Analysis_Demo_`filedate'_`filenum'.xls, ///
	excel append dec(5) ///
	ctitle("ln_emp_share`word'", "OLS", "robust") ///
	sortvar(ln_pop_share_25_29 ln_pop_share_20_29)
		
	ivregress 2sls ln_emp_share`word' i.year i.lmr_id ///
	...
	outreg2 using ${anal}/Analysis_Demo_`filedate'_`filenum'.xls, ///
	excel append dec(5) ///
	ctitle("ln_emp_share`word'", "2SLS", "robust") ///
	sortvar(ln_pop_share_25_29 ln_pop_share_20_29)
